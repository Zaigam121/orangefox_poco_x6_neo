...
# Version
TW_DEVICE_VERSION := Zag_The_Noob-A15-1

# Crypto & Hardware Disk Encryption (FDE Injection)
TARGET_HW_DISK_ENCRYPTION := false
TW_INCLUDE_CRYPTO := true
TW_INCLUDE_CRYPTO_FBE := true

# Mandatory Decryption Dependencies
TARGET_USES_MKE2FS := true
...
VENDOR_SECURITY_PATCH   := $(PLATFORM_SECURITY_PATCH)
BOOT_SECURITY_PATCH     := $(PLATFORM_SECURITY_PATCH)
# Touch & Graphics Lag Fix
TW_BRIGHTNESS_PATH := "/sys/class/leds/lcd-backlight/brightness"
TW_MAX_BRIGHTNESS := 2045
TW_SCREEN_BLANK_ON_BOOT := true
TW_OZIP_DECRYPT_KEY := 0

# Hardware Render Mode Acceleration
TW_BOARD_CUSTOM_GRAPHICS := ../../../bootable/recovery/graphics_fb.cpp
TW_EXTRA_FLAVOR := "With Fluid Touch UI"
